...
class CiudadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ciudade" do
    assert_difference('Ciudade.count') do
      post ciudades_url, params: { ciudade: { estado_id: @ciudade.estado_id, nombre: @ciudade.nombre } }
    end
  ...
  test "should update ciudade" do
    patch ciudade_url(@ciudade), params: { ciudade: { estado_id: @ciudade.estado_id, nombre: @ciudade.nombre } }
