...
class EstadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estado" do
    assert_difference('Estado.count') do
      post estados_url, params: { estado: { nombre: @estado.nombre, paise_id: @estado.paise_id } }
    end
  ...
  test "should update estado" do
    patch estado_url(@estado), params: { estado: { nombre: @estado.nombre, paise_id: @estado.paise_id } }
